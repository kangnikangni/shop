...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<?php if($_SESSION['user_name']== ""): ?><li>您好，欢迎来到京西！[<a href="<?php echo U('User/login');?>">登录</a>] [<a href="<?php echo U('User/register');?>">免费注册</a>] </li>
					<?php else: ?>
					<li>您好 <?php echo (session('user_name')); ?>，欢迎来到京西！[<a href="<?php echo U('User/logout');?>">退出</a>] </li><?php endif; ?>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			<!--  商品分类部分 start-->
			<?php if(strtolower(CONTROLLER_NAME)== "index" and strtolower(ACTION_NAME)== "index"): ?><!--首页-->
	...
	<script type="text/javascript">
		//定义全局变量
		var addUrl = "<?php echo U('Cart/add');?>";
	</script>
	<!-- jqzoom 效果 -->
	<script type="text/javascript">
		$(function(){
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo (ltrim($pics["0"]["pics_big"],'.')); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo (ltrim($pics["0"]["pics_mid"],'.')); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<?php if(is_array($pics)): $i = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
								<?php if($i == 1): ?><li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo (ltrim($vv["pics_mid"],'.')); ?>',largeimage: '<?php echo (ltrim($vv["pics_big"],'.')); ?>'}"><img src="<?php echo (ltrim($vv["pics_sma"],'.')); ?>"></a>
								</li>
								<?php else: ?>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo (ltrim($vv["pics_mid"],'.')); ?>',largeimage: '<?php echo (ltrim($vv["pics_big"],'.')); ?>'}"><img src="<?php echo (ltrim($vv["pics_sma"],'.')); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo ($info['goods_price'] / 10); ?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo (date('Y-m-d',$info["add_time"])); ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="" method="post" class="choose">
						<ul>
							<?php if(is_array($multi)): $i = 0; $__LIST__ = $multi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="product">
								<dl>
									<dt><?php echo ($vo["attr_name"]); ?>：</dt>
									<dd>
										<?php if(is_array($vo["attr_value"])): $i = 0; $__LIST__ = $vo["attr_value"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($i == 1): ?><a class="selected" href="javascript:;"><?php echo ($v); ?><input type="radio" name="color" value="<?php echo ($v); ?>" checked="checked" /></a>
										<?php else: ?>
										<a href="javascript:;"><?php echo ($v); ?><input type="radio" name="color" value="<?php echo ($v); ?>" /></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
									</dd>
								</dl>
							...
							<li>
								<dl>
									<dt>&nbsp;</dt>
									<dd>
										<input type="button" data="<?php echo ($info["goods_id"]); ?>" value="" id="add_btn" class="add_btn" />
									</dd>
								</dl>
							</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($single)): $i = 0; $__LIST__ = $single;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li><span><?php echo ($vol["attr_name"]); ?>：</span><?php echo ($vol["attr_value"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
