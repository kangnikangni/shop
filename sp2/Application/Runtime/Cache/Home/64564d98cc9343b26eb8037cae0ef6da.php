...
<body>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="pay">
				...
				<div class="pay_select">
					<table>
						<tr class="cur">
							<td class="col1"><input type="radio" checked="checked" name="order_pay" value="0" />支付宝</td>
							<td class="col2">使用支付宝在线支付</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="order_pay" value="1" />微信</td>
							<td class="col2">使用微信扫码支付</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="order_pay" value="2" />银行卡</td>
							<td class="col2">使用网银支付</td>
						</tr>
					</table>
				</div>
			</div>
			...
			<!-- 发票信息 start-->
			<div class="receipt">
				<h3>发票信息 <a href="javascript:;" id="receipt_modify"></a></h3>
				...
				<table>
					...
					<tbody>
						<?php if(is_array($cartInfo)): $i = 0; $__LIST__ = $cartInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
							<td class="col1"><a href="/sp2/index.php/Home/Goods/detail/goods_id/<?php echo ($vol["goods_id"]); ?>"><img src="<?php echo ($vol["thumb"]); ?>" alt="" /></a>  <strong><a href="/sp2/index.php/Home/Goods/detail/goods_id/<?php echo ($vol["goods_id"]); ?>"><?php echo ($vol["goods_name"]); ?></a></strong></td>
					...
					<tfoot>
						<tr>
							<td colspan="5">
								<ul>
									<li>
										<span><?php echo ($total["number"]); ?> 件商品，总商品金额：</span>
		...
		<div class="fillin_ft">
			<a href="javascript:;" id="submitBtn"><span>提交订单</span></a>
