			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li>
						<dl>
							<dt><a href="/sp2/index.php/Home/Goods/detail/goods_id/<?php echo ($vol["goods_id"]); ?>"><img src="<?php echo (ltrim($vol["goods_small_logo"],'.')); ?>" alt="" /></a></dt>
							<dt><a href="/sp2/index.php/Home/Goods/detail/goods_id/<?php echo ($vol["goods_id"]); ?>"><?php echo ($vol["goods_name"]); ?></a></dt>
							<dt><strong>￥<?php echo ($vol["goods_price"]); ?></strong></dt>
							<dt><a href="/sp2/index.php/Home/Goods/detail/goods_id/<?php echo ($vol["goods_id"]); ?>"><em>已有10人评价</em></a></dt>
						</dl>
